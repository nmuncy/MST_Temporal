...
E1 = visual.TextStim(WIN, text='1 - Smooth\n\n2 - Rough\n\n3 - Sharp', color=COLOR, height=HEIGHT)
E2 = visual.TextStim(WIN, text='1 - Metal\n\n2 - Plastic\n\n3 - Other', color=COLOR, height=HEIGHT)
E3 = visual.TextStim(WIN, text='1 - Heavy\n\n2 - Medium\n\n3 - Light', color=COLOR, height=HEIGHT)
TIME_ANS = visual.TextStim(WIN, text='1 - Longer\n\n2 - Same Time\n\n3 - Shorter', color=COLOR, height=HEIGHT)
...
if mem3 == 1:
    ...
    # pause after block
    POST_Block = visual.TextStim(WIN, text="Well done - you have finished block 3/3. \n\nPlease wait to continue.", color = COLOR, units = "pix", height = HEIGHT)
    POST_Block.draw()
    WIN.flip()
    event.waitKeys(keyList = ["p"])
