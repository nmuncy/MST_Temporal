...
parDir=~/compute/Temporal/Experiment3				  			# parent dir, where derivatives is located
...
deconPref=(Encoding Response)											# array of prefix for each planned decon (length must equal sum of $deconNum)
